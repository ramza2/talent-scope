...
def enqueue_upload_identify(upload_session_id: UUID) -> None:
    """Enqueue identify task. Raises on broker failure (caller restores status)."""
    identify_upload_session.delay(str(upload_session_id))
